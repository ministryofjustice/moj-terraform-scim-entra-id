...
from function.app import get_azure_access_token, get_entraid_aws_groups, get_entraid_group_members
...
class TestAzureFunctions(unittest.TestCase):
    ...
    def test_get_entraid_aws_groups(self, mock_get):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'value': [{'displayName': 'entraid-aws-identitycenter-group1'}]}
