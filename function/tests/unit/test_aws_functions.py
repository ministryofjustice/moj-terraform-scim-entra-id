...
class TestAWSFunctions(unittest.TestCase):
    ...
    def test_get_identity_center_username_existing_user(self, mock_boto_client):
        ...
        username = get_identity_center_username(identity_center_client, 'mocked_identity_store_id', 'mocked_user_id')
    ...
    def test_get_identity_center_username_nonexistent_user(self, mock_boto_client):
        ...
        identity_center_client.describe_user.side_effect = ClientError(
            {"Error": {"Code": "ResourceNotFoundException", "Message": "User does not exist"}},
            "DescribeUser"
        )

        username = get_identity_center_username(identity_center_client, 'mocked_identity_store_id', 'nonexistent_user_id')
    ...
    def test_get_group_membership_id_existing(self, mock_boto_client):
        ...
        membership_id = get_group_membership_id(identity_center_client, 'mocked_identity_store_id', 'mocked_group_id', 'mocked_user_id')
    ...
    def test_get_group_membership_id_nonexistent(self, mock_boto_client):
        ...
        membership_id = get_group_membership_id(identity_center_client, 'mocked_identity_store_id', 'mocked_group_id', 'nonexistent_user_id')
